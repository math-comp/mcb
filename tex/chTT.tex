...
\marginnote{The observation on pairs deserves more hammering. May be
  recall the code of the polymorphic pairs here. And in any case,
  ensure that this data structure has been seen in chapter~\ref{ch:prog}}
