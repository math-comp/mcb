...
term \C{(top x)}.  The \C{_} is a place holder for the top item.
...
Ssreflect from the \C{apply} tactic of \Coq{}.  Indeed the two tactics, while
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mcbLEVEL{1}
\mcbsection{The status of Axioms}
...
field~\cite{DBLP:conf/itp/Cohen12}.\marginnote{TODO Cyril: say more about RCF}
