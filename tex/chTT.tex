...
\gotcha{The colon symbol in \C{apply:} is not the dischargin operator.
...
playing similar roles, behave very diferently.}
...
is the construction of the real closure of an Archimedian field~\cite{cyril}.\marginnote{TODO Cyril: say more about RCF}
