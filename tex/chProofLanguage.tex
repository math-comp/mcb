...
Here we details the tools the \mcbSSR{} proof language give us
to tame bookkeeping, proof structuring and finally proof maintenance.


In this chapter we describe two important aspects of formal proofs
that can 
Importantly, it
