...
Such view is in fact accompanied by an implicit argument declaration
as follows:
...
Whwn the simplification tactic \C{/=} unfolds too aggressively,
...
of algebraic structure is minor.  The job of
