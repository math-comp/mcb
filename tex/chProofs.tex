...
Prove the following lemmas by rewriting:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{Exercise}[label=ex:induction,difficulty=0,title={Induction}]

Prove the following lemmas by induction:
