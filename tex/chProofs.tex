...
Let's anatomize the two examples above. Indeed, just like \Coq{}'s
...
%
% \begin{coq}{title=possible examples}
...
% arrows that are common to this chapter and the preceding.
%
% \begin{coq}{}
