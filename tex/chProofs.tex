...
that there are infinitely many primes.  Given a number \C{m}
...
list_ind : forall A : Type, forall P : list A -> Prop,
  P nil -> (forall x xs, P xs -> P (x :: xs)) -> forall l, P l.
\end{coqout}
...
a list starting from its end.  For example to relate the
...
\begin{coq}{}{}
Lemma silly_example m : n + 0 = (n + 0) + 0.
