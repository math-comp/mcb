...
hand side can be written as \C{m * n1 - m * n2}, which in turns
factors into \C{m * (n1 - n2)}. We then conclude using
lemma \C{muln_eq0}.
...
where we have two parameters \C{f} and \C{g} and one universal
quantification.
...
\marginnote{Were sections already mentionned in chapter 1?}
