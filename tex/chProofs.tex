...
\begin{coq}{def=LeqMul2lproof1}{title=Unfolding leq,width=7.7cm}
...
\begin{coq}{def=LeqMul2lproof1}{title=Unfolding leq repeatedly,width=7.7cm}
Lemma leq_mul2l m n1 n2 :
(m * n1 <= m * n2) = (m == 0) || (n1 <= n2).
Proof.
rewrite !leq_def.
...
\begin{coq}{def=LeqMul2lproof2}{title=Rewrite right-to-left,width=7.7cm}
Lemma leq_mul2l m n1 n2 :
(m * n1 <= m * n2) = (m == 0) || (n1 <= n2).
Proof.
rewrite !leq_def.
...
\begin{coq}{def=LeqMul2lproof3}{title=Closing up, width=7.7cm}
Lemma leq_mul2l m n1 n2 :
(m * n1 <= m * n2) = (m == 0) || (n1 <= n2).
Proof.
rewrite !leq_def.
...
\begin{coq}{def=LeqMul2lproof}{title=Multiple rewrite rules}
Lemma leq_mul2l m n1 n2 : (m * n1 <= m * n2) = (m == 0) || (n1 <= n2).
