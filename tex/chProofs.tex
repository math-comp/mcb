...
Now, to prove the lemma we need to use the two already existing
lemmas \C{add0n} and \C{addnC}.  In particular the equality predicate
...
for \C{addnC} and hence is useless.
