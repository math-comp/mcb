...
The rules of the \mcbCIC{}, as the ones schetched in~\ref{sec:ttch},
...
\end{coq}
where \C{.*2} is a postfix notation, smilar to \C{.+1}, 
...
\lib{bigop} file in order get acquainted with the nameing policy used
in that library.
