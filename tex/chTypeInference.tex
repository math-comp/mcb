...
\lstinline/true/ into 1 and \lstinline/false/ into 0.
...
\lstinline/(sort e)/ and \lstinline/e/ as the user initially wrote.
Indeed \lstinline/e/ is a term (or type \lstinline/eqType/) while
...
\lstinline/Implicit Types/ directive.
...
Concluding remarks about coercions and their positioning w.r.t.
literature: they don't model sub typing, CS do.
