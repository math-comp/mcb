...
refer to~\cite[section 4.2, ``Extensions of Gallina'']{Coq:manual}.  Here
...
%\mcbREQUIRE{bigop}
%\mcbPROVIDE{BigBody}
\section{Stable notations for big operators \mcbLEVELxx{}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\mcbREQUIRE{Canonical}
%\mcbPROVIDE{Notation}
\section{Working with overloaded notations \mcbLEVELx{}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Querying canonical structures \mcbLEVELx{}}\label{sec:phantom}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%555
\subsection{Phantom types \mcbLEVELxx{}}
