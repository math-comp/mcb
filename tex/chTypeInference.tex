...
\C{big_nil}.  Of course the following search finds it, but it is very
...
The recommended way is to search the library by name, using the word
...
lemmas pulling out elements from the iteration with
\C{(Search "rec" "big")}; lemmas  working on the filter condition
