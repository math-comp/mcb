...
So far we have been using only the simplest for of type inference in
...
projections are nothing special: they are simple functions that pattern
...
\C{Equality.sort} projection as a coercion. This makes possible to
...
We can then parametrize an entire theory on this interface.
...
beign folded is \C{nil}, then the result is the initial value.  Such
