...
\mcbPROVIDE{Phantom}
\mcbLEVEL{3}
\mcbsection{Querying canonical structures}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if one of their argumets validates an inferface.  For example
...
types used to trigger canonical strcuture resolution.
...
a projection to an unknow canonical structure instance.

\begin{coq}{name=phantom}{}
Inductive phantom (T : Type) (p : Type) := Phantom.
\end{coq}

The \C{Phant} constructor expects two arguments.  If we apply
