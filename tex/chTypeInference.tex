...
the right number of \lstinline/_/ for him. Here
...
The command \C{About} provides the user with the type of a given
constant, and with the status, implicit or not, of each argument of
the constant.
