...
\mcbPROVIDE{\\in}
\mcbLEVEL{1}
\mcbsection{Building a generic theory}\label{sec:eqtypetheory}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mcbLEVEL{1}
\mcbsection{Canonical inference keyed on a term}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Here we quickly present the minimal interfae an operation has to
