...
we have seen earlier in the book: outside of the section \C{Definitions},
the \C{Variables} \C{(T : Type)} and \C{(idm : T)} are lambda-lifted,
and \C{T} is maximally inserted: applying \C{law} to \C{idx} thus yields
a valid \C{Type}.
