...
%% YB: I am puzzled by the next sentence.  I don't know whether
%% the author wishes the reader to be quickly put in the middle of a
%% large library of formalized concepts (in the book), or whether the
%% the author complains that the reader is put in the middle of large library
%% in the other documents.  If it is the latter, then I suggest adding
%% ``in reference manuals'' after ``However''.
...
% inventing new math... the cultural background is important to be up to
...
% 	to synthesize the cut formula out of the minimum possible user input, as
...
%       triviality (via //, hint resolve, canonical) is for free. E.g.
%       "x \\is a toto", "0 <= n", ...
...
%
% \mantra{(basic) if you see toto=false you should perform the case analysis via
% fooP
% }
