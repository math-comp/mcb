...
% 
% 
% What makes sense really means depends too
...
\mcbPROVIDE{fintype}
\mcbNOTES{}
\mcbsection{Finite types and ordinals}
...
subtypes are good to keep operations (on nat here) and develop
...
\mcbPROVIDE{tuple}
\mcbNOTES{}
\mcbsection{Tuples and proof search}
...
\mcbsection{Building the \lstinline/eqType/ for \lstinline/n.-tuples
T/ via the \lstinline/subType/ kit}
...
\mcbREQUIRE{}
\mcbsubsection{The toolkit to declare a new sub-type}
