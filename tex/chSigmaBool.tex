...
checks that the index is smaller than the size of the tuple.
...
Indeed the left hand side has type \C{'M_(m, n1 + (n2 + n3))} while
...
Indeed the real declaration puts \C{reflect} in \C{Type} and not in
\C{Prop}.
