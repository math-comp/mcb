...
\mcbPROVIDE{fintype}
\mcbNOTES{}
\mcbsection{The interface for finite types and the ordinal subtype}
...
\mcbPROVIDE{tuple}
\mcbNOTES{}
\mcbsection{Intermezzo: Tuples and proof search}
...
\mcbsection{The \lstinline/subType/ kit}
...
\mcbREQUIRE{}
\mcbsubsection{The sub-type kit in details}
