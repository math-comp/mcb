...
here.  If \C{A} has a known type \C{'M[R]_(m,n)}, then type inference
...
they make the writing of matrix expressions extremely succinct, in some case
...
Indeed the real declaration puts reflect in \C{Type} and not in
\C{Prop}.
