...
%\mcbREQUIRE{}
\subsection{The sub-type kit \mcbLEVELx{}}
...
\marginnote{FIXME: the data-structure of finite functions is about to change in the library. }
...
their cannot be a registered instance of finite type for \C{nat}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Size casts \mcbLEVELx{}}\label{sec:castmx}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Sorts and \C{reflect} \mcbLEVELxx{}}
