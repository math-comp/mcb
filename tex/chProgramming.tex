...
\begin{itemize}
	\item write rev, flatten, iter/nat
	\item write nth with a default value
	\item write plus and times using iter
	\item write \C{tuple_enum}, i.e. given a list of symbols generate all
sequences of a given length made of these symbols with no repetitions.
\end{itemize}
