...
known property can be stated explicitly.  For a mathematical reader,
...
Observe that we did omit the type of the input \C{n}. We can omit this
...
\cite[section 6.1.2, ``Interpretation scopes'']{Coq:manual}).\index[concept]{notation scope}
