...
\subsection{Defining functions}\label{ssec:deffun}
...
\subsection{Recursion for natural numbers}\label{ssec:recnat}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{More container datatypes}\label{sec:othercontainers}
...
Type  \C{(option A)} contains a copy of all the elements of \C{A},
...
\marginnote{assia: it is a very difficult exercise, isnt'it?}
