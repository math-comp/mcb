...
abstracted for \C{iter} when the section is closed. We leave as an
exercise to the reader the decomposition of the similar abstraction
process happening for the definition of \C{foldr} in the section.
...
And this expression computes to 6, as expected.
