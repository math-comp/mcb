...
\section[#1 \mcbpptxtlevel{\value{mcbvarLEVEL}}]{#1\hfill\mcbpptxtlevel{\value{mcbvarLEVEL}}}
%\smash{\raisebox{0.7cm}{\hspace{0.9\textwidth}\mcbpptxtlevel{\value{mcbvarLEVEL}}}}
...
\subsection[#1 \mcbpptxtlevel{\value{mcbvarLEVEL}}]{#1\hfill\mcbpptxtlevel{\value{mcbvarLEVEL}}}
%\smash{\raisebox{0.7cm}{\hspace{0.9\textwidth}\mcbpptxtlevel{\value{mcbvarLEVEL}}}}
%\marginnote{\small\begin{tabular}{p{3.8cm}}\hline
%\textbf{Learns} \mcbvarLEARN \\
%\textbf{Requires} \mcbvarREQUIRE \\
...
\subsubsection[#1 \mcbpptxtlevel{\value{mcbvarLEVEL}}]{#1\hfill\mcbpptxtlevel{\value{mcbvarLEVEL}}}
%\smash{\raisebox{0.7cm}{\hspace{0.9\textwidth}\mcbpptxtlevel{\value{mcbvarLEVEL}}}}
%\marginnote{\small\begin{tabular}{p{3.8cm}}\hline
%\textbf{Learns} \mcbvarLEARN \\
%\textbf{Requires} \mcbvarREQUIRE \\
